...
from bcal_log import log_monitor_file

config = {
    #"base_de_datos": "/home/marcos/bcal.db",
    "base_de_datos": "/Users/marcos/Desktop/bcal1/bcal.db",
    "registro": "/Users/marcos/Desktop/bcal1/registro.log",
    "servidores": [
...
if __name__ == "__main__":
    print("** bcal v0")
    register = log_monitor_file(config['registro'])
    ...
    if cmd == "help":
        ...
        db = local_storage_sqlite3(config['base_de_datos'], register)
        for i in db.list():
            print(i)
        ...
        for s in config['servidores']:
            ...
            a = remote_storage_http(s, register)
            b = a.read()
            if len(b)>0:
                dd = dd + b['data']
        db = local_storage_sqlite3(config['base_de_datos'], register)
...
# sqlite3 bcal.db -init bcal.sql
# sqlite3 bcal.db "select * from d;"
